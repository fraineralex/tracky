...
export default async function DataAndHabits({
	...
	return (
		<section className='mx-auto mt-3 grid max-w-[460px] grid-cols-2 gap-3 md:flex md:max-w-full md:gap-0 md:space-x-2 lg:justify-between'>
			<InsightsCard
				title='Nutrition'
				dateRange={dateRange}
				value={caloriesChanges}
				valueUnit='kcal'
				className='w-56 rounded-lg border p-4 pb-1 dark:bg-slate-800/50 md:w-full md:max-w-xs'
			>
